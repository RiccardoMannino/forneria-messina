    ...
    <>
      <Section className="my-20 flex flex-col gap-6 p-8 text-base text-white md:mx-20 md:my-20 md:text-xl">
        ...
        <p>
          ...
          dati personali). In riferimento al trattamento dei vostri dati
          personali, desideriamo informarVi che: I dati personali da Voi forniti
          o acquisiti nell’ambito dei rapporti contrattuali con Voi
          intercorrenti, vengono utilizzati allo scopo di adempiere agli
          obblighi derivanti dal contratto con Voi stipulato, per assolvere agli
          obblighi civilistici e fiscali, nonché per la tenuta della
          contabilità, per la fatturazione, la gestione del credito e per
          finalità commerciali Ove espressamente autorizzato, i dati personali
          possono essere utilizzati da Forneria Messina e/o da terzi anche per
          attività promozionali e di marketing Tali trattamenti consistono nella
          raccolta, registrazione, organizzazione, conservazione, modificazione,
          consultazione, elaborazione, estrazione, selezione, interconnessione,
          raffronto, utilizzo, blocco, cancellazione e distruzione dei dati
          stessi, nell’ottica del minimo utilizzo necessario in relazione alla
          motivazione alla base del trattamento stesso Il trattamento dei dati
          conferiti avviene nel rispetto delle norme vigenti, a mezzo di
          strumenti cartacei ed informatici idonei a tutelare la Vostra
          sicurezza e riservatezza, nel rispetto delle misure minime previste
        ...
        <p>
          ...
          impedirebbe di instaurare rapporti con la ditta Forneria Messina I
          dati forniti o acquisiti nel corso del rapporto contrattuale non
          saranno diffusi, ma potranno essere comunicati a soggetti esterni che
          svolgono specifici incarichi per conto dell’azienda, quali
          commercialisti, studi legali, istituti di credito, società di
          trasporto, società di recupero crediti, società di servizi informatici
          I dati conferiti saranno trattati da personale incaricato nominato
          direttamente dal Responsabile del Trattamento In assenza di richiesta
          specifica di cancellazione, i dati conferiti saranno conservati per 5
          anni dal termine del rapporto contrattuale (o per i tempi minimi
          previsti dalla legge, qualora superiori) Titolare del trattamento è
          Forneria Messina di Messina G. & C. Snc con sede legale in Via Vi
          informiamo altresì che il GDPR e l’art. 7 del D. Lgs. 196/2003
          riconoscono all’interessato il diritto di: chiedere la conferma
          dell’esistenza dei dati personali che lo riguardano, avere
          informazioni sul trattamento dei medesimi, richiederne
          l’aggiornamento, la rettifica, l’integrazione, la cancellazione, la
          trasformazione in forma anonima e il blocco dei dati personali,
          trattati in violazione di legge, ottenere copia dei dati personali
          raccolti, opporsi al trattamento per motivi legittimi, ottenere
          l’intervento del Garante e dell’Autorità Giudiziaria in caso di
          violazioni. Tale diritto può essere esercitato rivolgendo un’istanza a
          mezzo mail a EMAIL, che sarà gestita in tempo congruo in base alla
        ...
        <p>
          ...
          superiore protezione. Ulteriori informazioni in merito ai criteri di
          protezione sono reperibili nella sezione sull’applicabilità. Titolare
          del Trattamento dei Dati Forneria Messina di Messina G. & C. Snc Viale
          Regione Siciliana 100 San Martino delle Scale – Monreale (PA) P.IVA
          IT05788810827 Indirizzo email del Titolare: info@forneriashop.it
          Tipologie di Dati raccolti Fra i Dati Personali raccolti da Forneria
          Messina, in modo autonomo o tramite terze parti, ci sono: Cookie, Dati
          di utilizzo, email, nome, cognome e numero di telefono. Dettagli
          ...
          Personali possono essere liberamente forniti dall’Utente o, nel caso
          di Dati di Utilizzo, raccolti automaticamente durante l’uso di
        ...
        <p>
          ...
          il Titolare da qualsiasi responsabilità verso terzi. Modalità e luogo
          del trattamento dei Dati raccolti MODALITÀ DI TRATTAMENTO Il Titolare
          adotta le opportune misure di sicurezza volte ad impedire l’accesso,
        ...
        <p>
          ...
          nell’organizzazione di Forneria Messina (personale amministrativo,
        ...
        <p>
          ...
          seguenti condizioni: l’Utente ha prestato il consenso per una o più
          finalità specifiche; Nota: in alcuni ordinamenti il Titolare può
        ...
        <p>
          ...
          misure precontrattuali; il trattamento è necessario per adempiere un
          ...
          l’esercizio di pubblici poteri di cui è investito il Titolare; il
        ...
        <p>
          ...
          contratto o necessario per concludere un contratto. LUOGO I Dati sono
          trattati presso le sedi operative del Titolare ed in ogni altro luogo
          in cui le parti coinvolte nel trattamento siano localizzate. Per
          ulteriori informazioni, contatta il Titolare. I Dati Personali
        ...
        <p>
          ...
          diritto a ottenere informazioni in merito alla base giuridica del
        ...
        <p>
          ...
          in apertura. PERIODO DI CONSERVAZIONE I Dati sono trattati e
        ...
        <p>
          ...
          raccolti I Dati dell’Utente sono raccolti per consentire al Titolare
          di fornire i propri Servizi, così come per le seguenti finalità:
          Statistica, Gestione indirizzi e invio di messaggi email, Contattare
        ...
        <p>
          ...
          propri Dati il modulo di contatto, acconsente al loro utilizzo per
        ...
        <p>
          ...
          seguito. In ogni altro caso, l’Utente può contattare il titolare per
          scoprire quali diritti siano applicabili nel suo caso e come
        ...
        <p>
          ...
          avviene su una base giuridica diversa dal consenso. Ulteriori dettagli
          ...
          ed a ricevere una copia dei Dati trattati. verificare e chiedere la
          rettificazione. L’Utente può verificare la correttezza dei propri Dati
        ...
        <p>
          ...
          conservazione. ottenere la cancellazione o rimozione dei propri Dati
          Personali. Quando ricorrono determinate condizioni, l’Utente può
        ...
        <p>
          ...
          ad un altro titolare. Questa disposizione è applicabile quando i Dati
          sono trattati con strumenti automatizzati ed il trattamento è basato
          sul consenso dell’Utente, su un contratto di cui l’Utente è parte o su
          misure contrattuali ad esso connesse. proporre reclamo. L’Utente può
        ...
        <p>
          ...
          trattamento per motivi connessi alla loro situazione particolare. Si
        ...
        <p>
          ...
          parte delle disposizioni di questo documento vale nei confronti di
          tutti gli Utenti, alcune sono espressamente assoggettate
        ...
        <p>
          ...
          all’offerta di beni o servizi a titolo oneroso o gratuito a tali
          Utenti; riguarda Dati Personali di Utenti che si trovano nella UE e
